        ...
        <article class="global-wrapper hentry" id="post-<?php the_ID(); ?>" role="article">
            ...
            <?php if ( '' !== get_the_post_thumbnail() ) : ?>
                <div class="post-thumbnail">
                    ...
                    $size = apply_filters( 'yates_blog_thumbnail_size', 'medium' );
                    $args = apply_filters( 'yates_blog_thumbnail_args', [
                        'class' => 'alignnone'
                    ] );
                ...
                <?php if ( 'excerpt' == yates_sanitize_blog_content_format( get_theme_mod( 'yates_blog_content_format' ) ) ) {
                    the_excerpt();
                } else {
                    the_content();
                } ?>
