...
$get_client   = get_field( 'yates_commercial_client' );
$get_title    = get_field( 'yates_commercial_title' );
$get_director = get_field( 'yates_commercial_director' );
$get_vimeo    = get_field( 'yates_commercial_vimeo_id' );
...
<article class="global-wrapper hentry" id="post-<?php the_ID(); ?>" role="article">
    <header class="entry-header">
        <?php echo apply_filters( 'yates_singular_title', the_title( '<h1 class="entry-title">', '</h1>' ) ); ?>
    </header>
